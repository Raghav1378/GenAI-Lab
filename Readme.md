...
I am a passionate AI enthusiast currently building a deep expertise in Generative AI. I am documenting my journey from learning the basics of LLMs to building complex, self-reasoning Multi-Agent systems.

---

### 🧠 What I am Learning / Mastering Right Now
...
### 📈 GenAI Roadmap & Progress

- [x] **Foundations:** Prompt Engineering, Temperature/Top-P tuning, Hallucinations.
- [x] **RAG (Retrieval Augmented Generation):** PDF Chatbots, semantic search.
- [ ] **LangGraph Specialization:** Human-in-the-loop, time-travel debugging.
- [ ] **Fine-tuning:** PEFT/LoRA for domain-specific tasks.
- [ ] **Evaluation:** Using LangSmith and RAGAS for testing AI quality.
...
### ⚡ Fun Fact
I spend more time talking to models than I do to my neighbors. 😅